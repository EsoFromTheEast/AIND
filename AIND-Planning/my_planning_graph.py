...
class PlanningGraph():
    ...
    def add_literal_level(self, level):
        ...
        # Update the Connection between actions & states
        for action in self.a_levels[level-1]:
            for state in self.s_levels[level]:
                if state in action.effnodes :
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return node_a1.action.effect_add == node_a2.action.effect_rem and node_a2.action.effect_add == node_a1.action.effect_rem
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return True if ([effect for effect in node_a2.action.effect_rem if effect in node_a1.action.precond_pos] or
                            [effect for effect in node_a2.action.effect_add if effect in node_a1.action.precond_neg] or
                            [effect for effect in node_a1.action.effect_rem if effect in node_a2.action.precond_pos] or
                            [effect for effect in node_a1.action.effect_add if effect in node_a2.action.precond_neg]) else False
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return True if ([cond1 for cond1 in node_a1.parents for cond2 in node_a2.parents if cond1.is_mutex(cond2)]) else False
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        return False if ([cond1 for cond1 in node_s1.parents for cond2 in node_s2.parents if not cond1.is_mutex(cond2)]) else True
    ...
    def h_levelsum(self) -> int:
        ...
        for goal in self.problem.goal :
            ...
            for num,item in enumerate(self.s_levels):
                if goal_node in item :
                    level_sum += num
                    break
